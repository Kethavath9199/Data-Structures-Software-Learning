...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Click += gcnew System::EventHandler(this, &Searching::button1_Click);
			// 
			// lblWelcome
			// 
			...
			this->lblWelcome->Size = System::Drawing::Size(722, 20);
...
#pragma endregion
	...
	public: void display(){
				...
				if(moduleId == 0){
					...
					LinearSearch ^newUserControl = gcnew LinearSearch();
					...
					btnNext->Show();
					MainPanel->Controls->Clear();
					BinarySearch ^newUserControl = gcnew BinarySearch();
					newUserControl->username = username;
					MainPanel->Controls->Add(newUserControl);
				}
				else if(moduleId == 2){
