...
namespace DataStructuresLearningSoftware {
	...
	/// <summary>
	/// Summary for UI_Linear_Queue_Animation
	/// </summary>
	public ref class UI_Linear_Queue_Animation : public System::Windows::Forms::UserControl
	{
	public:
		UI_Linear_Queue_Animation(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dqbtn->Click += gcnew System::EventHandler(this, &UI_Linear_Queue_Animation::dqbtn_Click);
			// 
			// enqbtn
			// 
			...
			this->enqbtn->Click += gcnew System::EventHandler(this, &UI_Linear_Queue_Animation::enqbtn_Click);
			// 
			// label1
			// 
			...
			this->arraybtn->CheckedChanged += gcnew System::EventHandler(this, &UI_Linear_Queue_Animation::arraybtn_CheckedChanged);
			// 
			// llbtn
			// 
			...
			this->Name = L"UI_Linear_Queue_Animation";
			this->Size = System::Drawing::Size(1105, 670);
			this->Load += gcnew System::EventHandler(this, &UI_Linear_Queue_Animation::UI_Linear_Queue_Animation_Load);
...
#pragma endregion
	...
	private: System::Void UI_Linear_Queue_Animation_Load(System::Object^  sender, System::EventArgs^  e) {
