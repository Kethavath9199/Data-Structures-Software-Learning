...
namespace DataStructuresLearningSoftware {
	...
	/// <summary>
	/// Summary for UI_Circular_Queue_Array
	/// </summary>
	public ref class UI_Circular_Queue_Array : public System::Windows::Forms::UserControl
	{
	public:
		UI_Circular_Queue_Array(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(UI_Circular_Queue_Array::typeid));
			...
			this->label1->Location = System::Drawing::Point(280, 18);
			...
			this->richTextBox1->TextChanged += gcnew System::EventHandler(this, &UI_Circular_Queue_Array::richTextBox1_TextChanged);
			// 
			// UI_Circular_Queue_Array
			// 
...
#pragma endregion
	...
	private: System::Void UI_Circular_Queue_Array_Load(System::Object^  sender, System::EventArgs^  e) {
			 }
	};
}
